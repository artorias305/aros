...
ISR_STUB(15)
ISR_STUB(16)
ISR_STUB(17) ISR_STUB(18) ISR_STUB(19) ISR_STUB(20) ISR_STUB(21) ISR_STUB(22)
	ISR_STUB(23) ISR_STUB(24) ISR_STUB(25) ISR_STUB(26) ISR_STUB(27)
		ISR_STUB(28) ISR_STUB(29) ISR_STUB(30) ISR_STUB(31) ISR_STUB(32)
			ISR_STUB(33)

				static void (*const isr_table[32])(void) = {
					isr_0,	isr_1,	isr_2,	isr_3,	isr_4,	isr_5,	isr_6,
