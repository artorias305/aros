...
OBJS := build/main.o build/serial.o build/vga.o build/gdt.o build/idt.o build/keyboard.o build/kprintf.o build/shell.o build/timer.o build/pmm.o build/paging.o
